...
#time ./testcase-1.sh ${version}-${network}-sno${nodes}-74 74 1 | tee ${version}-${network}-sno${nodes}-tc1.log
#sleep ${sleep_time}
# Test case 2 is a variation of testcase 1
#time ./testcase-1.sh ${version}-${network}-sno${nodes}-74 74 2 | tee ${version}-${network}-sno${nodes}-tc2.log
#sleep ${sleep_time}
